...
printHeader() {
    ...
    echo -e "${CYAN}                                            ${NC}"
    echo -e "${CYAN}                                            ${NC}"
    echo -e "${CYAN}  https://github.com/0xlimon/Story-Node-Management-Telegram-Bot${NC}"
    echo -e "${CYAN}******************************************************${NC}"
}
...
installBot() {
    ...
    cd /root
    git clone https://github.com/0xlimon/Story-Node-Management-Telegram-Bot.git
    BOT_DIR="/root/Story-Node-Management-Telegram-Bot"
    cd $BOT_DIR
...
ADMIN_ID=${admin_id}
RPC_ENDPOINT_1=https://story-testnet-rpc.itrocket.net/status
RPC_ENDPOINT_2=https://story-testnet.rpc.kjnodes.com/status
...
uninstallBot() {
    ...
    rm -rf /root/Story-Node-Management-Telegram-Bot
